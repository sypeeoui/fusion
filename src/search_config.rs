...
pub struct SearchConfig {
    ...
    pub b2b_weight: f32,
    pub downstack_weight: f32,
    pub downstack_avg_height_weight: f32,
    pub downstack_min_height_weight: f32,
    pub pc_mode: bool,
    pub debug_pc: bool,
...
impl Default for SearchConfig {
    fn default() -> Self {
        Self {
            ...
            chain_weight: 0.15,
            b2b_weight: 0.20,
            downstack_weight: 0.20,
            downstack_avg_height_weight: 0.0,
            downstack_min_height_weight: -5.0,
            pc_mode: false,
            debug_pc: false,
            context_weight: 0.25,
            board_weight: 1.0,
...
pub struct SearchResultFull {
    ...
    pub chain_score: f32,
    pub b2b_score: f32,
    pub downstack_score: f32,
    pub context_score: f32,
    pub path_attack: f32,
    pub path_chain: f32,
    pub path_b2b: f32,
    pub path_downstack: f32,
